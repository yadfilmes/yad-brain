...
| nota | citada por |
|---|---|
| `abnt` | `bitola-de-cabo` (governed_by), `rede-ac` (governed_by) |
...
| `balanceamento-de-fase` | `gerador` (see_also) |
...
| `bitola-de-cabo` | `abnt` (see_also), `balanceamento-de-fase` (see_also), `gerador` (requires), `rede-ac` (requires) |
...
| `evoke-2400b` | `ls-600d-pro` (competes_with), `mount--nanlux` (see_also), `nanlux` (see_also) |
...
| `gerador` | `balanceamento-de-fase` (see_also), `bitola-de-cabo` (see_also), `rede-ac` (alternative_to) |
...
| `ls-600d-pro` | `aputure` (see_also), `evoke-2400b` (competes_with), `mount--bowens` (see_also) |
...
| `midia--codex-compact-drive` | `alexa-35` (accepts_media), `midia--cfexpress-b` (alternative_to) |
| `midia--sxs` | `venice` (accepts_media) |
| `mount--bowens` | `ls-600d-pro` (fits), `mount--nanlux` (alternative_to) |
| `mount--e` | `fx6` (has_native_mount), `mount--lpl` (alternative_to), `mount--pl` (alternative_to), `venice` (has_native_mount), `venice-2` (has_native_mount) |
| `mount--lpl` | `alexa-35` (has_native_mount), `mount--pl` (see_also) |
| `mount--nanlux` | `evoke-2400b` (fits), `mount--bowens` (alternative_to) |
...
| `mov` | `prores` (wraps_in) |
| `mte` | `nr-10-eletricidade` (governed_by), `nr-35-trabalho-em-altura` (governed_by) |
| `mxf` | `xavc` (wraps_in) |
| `nanguang` | `nanlux` (owned_by) |
| `nanlite` | `nanlux` (distinct_from) |
| `nanlux` | `aputure` (competes_with), `evoke-2400b` (made_by), `mount--nanlux` (made_by) |
...
| `nr-10-eletricidade` | `abnt` (see_also), `balanceamento-de-fase` (requires), `bitola-de-cabo` (requires), `gerador` (requires), `rede-ac` (see_also) |
| `nr-35-trabalho-em-altura` | `gaffer` (requires), `mte` (see_also), `nr-10-eletricidade` (see_also) |
| `obturador-180` | `filtro-nd` (enables_technique), `flicker-parede-led` (diagnosed_with), `flicker-parede-led` (see_also), `fx6` (enables_technique), `scan-rate` (see_also), `venice-2` (enables_technique) |
...
| `rede-ac` | `abnt` (see_also), `balanceamento-de-fase` (requires), `bitola-de-cabo` (requires), `evoke-2400b` (powered_by), `gerador` (alternative_to), `ls-600d-pro` (powered_by), `nr-10-eletricidade` (requires) |
